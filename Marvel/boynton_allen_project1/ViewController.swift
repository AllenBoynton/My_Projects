...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        hero5.image = "Captain_America.jpeg"
        ...
        hero7.image = "Silver_Surfer.jpeg"
        ...
        hero11.image = "Doctor_Strange.png"
        ...
        hero20.image = "Human_Torch.jpg"
        
        // Pass in the heroes into the storyboard
        dataArray.append(hero1)
        dataArray.append(hero2)
        dataArray.append(hero3)
        dataArray.append(hero4)
        dataArray.append(hero5)
        dataArray.append(hero6)
        dataArray.append(hero7)
        dataArray.append(hero8)
        dataArray.append(hero9)
        dataArray.append(hero10)
        dataArray.append(hero11)
        dataArray.append(hero12)
        dataArray.append(hero13)
        dataArray.append(hero14)
        dataArray.append(hero15)
        dataArray.append(hero16)
        dataArray.append(hero17)
        dataArray.append(hero18)
        dataArray.append(hero19)
        dataArray.append(hero20)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell: ObjectViewCell = tableView.dequeueReusableCellWithIdentifier("MyCell")! as! ObjectViewCell
    ...
    func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if (editingStyle == .Delete) {
            ...
            heroView.deleteRowsAtIndexPaths([indexPath], withRowAnimation: UITableViewRowAnimation.Automatic)
        }
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let indexPath: NSIndexPath? = heroView.indexPathForSelectedRow!
    ...
    @IBAction func myToggle(sender: UIButton) {
        
        heroView.editing = !heroView.editing
